...
player_urls = ['https://www.cbssports.com/fantasy/football/stats/weeklyprojections/QB/season/avg/standard?&print_rows=9999']
...
for player_url in player_urls:
    ...
    for player_row in player_rows:
        ...
        for index, player_col in enumerate(player_cols):
            if (index == 1 or index == 2 or index == 6 or index == 7 or
                    index == 8 or index == 10 or index == 13):
                continue
            ...
            header_index = index
            if index == 3 or index == 4 or index == 5 or index == 12:
...
with open('../Server/src/main/resources/csv/cbs_qb_stats_2018_2019.csv', 'wb') as file:
