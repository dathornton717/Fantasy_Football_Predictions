...
player_urls = ['http://games.espn.com/ffl/tools/projections?&slotCategoryId=17',
    'http://games.espn.com/ffl/tools/projections?&slotCategoryId=17&startIndex=40']

players = []
idx = 0

# the headers of the urls
player_stats = ['NAME', 'TEAM', 'SITE', 'PAT', 'TEENS', 'TWENTIES', 'THIRTIES',
    'FORTIES', 'FIFTIES']
...
for player_url in player_urls:
    ...
    for player_row in player_rows:
        ...
        for index, player_col in enumerate(player_cols):
            ...
            slash_idx = player_text.index('/')
            player_text = player_text[:slash_idx]
...
with open('../Server/src/main/resources/csv/espn_k_stats_2018_2019.csv', 'wb') as file:
