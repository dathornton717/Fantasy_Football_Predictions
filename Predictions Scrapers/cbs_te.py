...
player_urls = ['https://www.cbssports.com/fantasy/football/stats/weeklyprojections/TE/season/avg/standard?&print_rows=9999']
...
# # if you want to print the tight ends
# #for player in players:
#     #for stat in player:
#         #print str(stat) + ' ' + player[stat]

# # write the quarterbacks out to a csv file
with open('../Server/src/main/resources/csv/cbs_te_stats_2018_2019.csv', 'wb') as file:
